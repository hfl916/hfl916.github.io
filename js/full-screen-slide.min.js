...
(function ($) {
    $.fn.setSlide = function (option) {
        ...
        return this.each(function () {
            var SlideIndex = 0, slideElem = set.slideElem.find(".slide-box"), switchingSpeed = set.switchingSpeed,
                isBlock = set.isBlock, fullScreenw = set.fullScreenw, fullScreenh = set.fullScreenh,
                slideLiw = set.slideLiw, slideLih = set.slideLih, slidePrev = set.prevEl, slideNext = set.nextEl,
                pagination = set.pagination, pagingTrigger = set.pagingTrigger, fn = set.fn,
                slideOut = slideElem.find(".slide-out"), slideLi = slideElem.find(".slide-li"),
                slideBullet = slideElem.find(".slide-pagination-bullet"), slideTime = set.slideTime,
            ...
            var oWidth = $('#myModal4').width()
            var oHeight = $('#myModal4').height()
            slideElem.css({"width": oWidth, "height": oHeight});
            slideLi.css({"width": oWidth, "height": oHeight});
            slideOut.css({"width": oWidth * slideLen, "height": oHeight});
            ...
            function slide(SlideIndex) {
                slideOut.stop().animate({"margin-left": "-" + oWidth * SlideIndex}, switchingSpeed);
